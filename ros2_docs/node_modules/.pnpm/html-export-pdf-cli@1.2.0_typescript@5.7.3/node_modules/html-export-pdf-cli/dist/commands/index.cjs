...
// node_modules/.pnpm/colorette@https+++registry.npmmirror.com+colorette+-+colorette-2.0.20.tgz/node_modules/colorette/index.js
...
function runCli(programName) {
  ...
  if (beforeParse) {
    beforeParse(import_commander.program);
  }
  import_commander.program.parse(import_node_process3.default.argv);
  if (afterParse) {
    afterParse(import_commander.program);
  }
}
