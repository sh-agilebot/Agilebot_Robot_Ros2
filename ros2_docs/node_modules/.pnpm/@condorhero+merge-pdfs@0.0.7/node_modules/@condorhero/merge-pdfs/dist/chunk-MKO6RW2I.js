import {
  formatDate
} from "./chunk-AUWOY3T6.js";
import {
  PKG_NAME
} from "./chunk-DGAUOXSG.js";
import {
  __commonJS,
  __dirname,
  __require,
  __toESM,
  init_esm_shims
} from "./chunk-6R4JPLGJ.js";

// src/pyodide/pyodide.js
var require_pyodide = __commonJS({
  "src/pyodide/pyodide.js"(exports, module) {
    "use strict";
    init_esm_shims();
    !function(global2, factory) {
      "object" == typeof exports && "undefined" != typeof module ? factory(exports) : "function" == typeof define && define.amd ? define(["exports"], factory) : factory((global2 = "undefined" != typeof globalThis ? globalThis : global2 || self).loadPyodide = {});
      ...
      }(stackframe), function(module2, exports3) {
        var StackFrame, FIREFOX_SAFARI_STACK_REGEXP, CHROME_IE_STACK_REGEXP, SAFARI_NATIVE_CODE_REGEXP;
        module2.exports = (StackFrame = stackframe.exports, FIREFOX_SAFARI_STACK_REGEXP = /(^|@)\S+:\d+/, CHROME_IE_STACK_REGEXP = /^\s*at .*(\S+:\d+|\(native\))/m, SAFARI_NATIVE_CODE_REGEXP = /^(eval@)?(\[native code])?$/, { parse: function(error) {
      ...
      function initializeFileSystem(Module, config) {
        ...
        stdLibURL = null != config.stdLibURL ? config.stdLibURL : config.indexURL + "python_stdlib.zip", function(Module2, stdlibURL) {
        ...
        }(Module, config._node_mounts), Module.preRun.push(() => function(module2) {
          const FS = module2.FS, MEMFS = module2.FS.filesystems.MEMFS, PATH = module2.PATH, nativeFSAsync = { DIR_MODE: 16895, FILE_MODE: 33279, mount: function(mount) {
          ...
          module2.FS.filesystems.NATIVEFS_ASYNC = nativeFSAsync;
        }(Module));
      }
...
async function mergePDFs(entry) {
  ...
  const pyodide = await (0, import_pyodide.loadPyodide)({ indexURL: resolve(__dirname2, "pyodide") });
