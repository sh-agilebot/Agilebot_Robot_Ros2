...
Instruction:
This file is used to visualize the URDF robot model in RViz and start the robot_bridge node to synchronize the physical robot state to RViz.
Start nodes: robot_state_publisher_node, rviz2_node, robot_bridge_node
"""
